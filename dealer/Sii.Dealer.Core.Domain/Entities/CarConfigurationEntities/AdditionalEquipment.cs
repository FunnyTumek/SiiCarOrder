...
{
    public class AdditionalEquipment : IConfigurationOption
    {
        private AdditionalEquipment()
        {
        }
        public AdditionalEquipment(string code, string name, bool availability, decimal price)
        {
            Validate(code, name);
        ...
        public virtual ICollection<AdditionalEquipmentSet> AdditionalEquipmentSet { get; private set; }
