...
{
    public class CarClass : IConfigurationOption
    {
        private CarClass()
        {
        }
        public CarClass(string code, string name, bool availability, decimal price)
        {
           Validate(code, name);
        ...
        public void ChangeAvailability(bool aviability)
        {
            Availability = aviability;
        }
