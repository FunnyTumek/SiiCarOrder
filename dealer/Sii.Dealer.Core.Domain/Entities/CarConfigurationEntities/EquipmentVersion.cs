...
{
    public class EquipmentVersion : IConfigurationOption
    {
        private EquipmentVersion()
        {
        }
        public EquipmentVersion(string code, string name, bool availability, decimal price)
        {
            Validate(code, name);
