...
{
    public partial class ChangeOrderedProductionsHistoryTableName : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "OrderedProductionsProgressStates",
                schema: "factory",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderedProductionsProgressStates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderedProductionsProgressStates_OrderedProductions_ProductionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderedProductionsProgressStates_ProductionId",
                schema: "factory",
